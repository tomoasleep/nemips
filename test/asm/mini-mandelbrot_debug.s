...
ble_else.133:
	sw	r28, 0(r29)
	sw	r2, -1(r29) # x_idx
	swf	f2, -2(r29) # y_float
	sw	r3, -3(r29) # y_idx
	swf	f3, -4(r29) # x_float
	sw	r31, -5(r29) # return
	addi	r29, r29, -6
	jal	min_caml_float_of_int # convert x
  owf f2
	addi	r29, r29, 6
	lw	r31, -5(r29)
	...
	sw	r31, -5(r29) 
	addi	r29, r29, -6
	jal	dbl.38 # x.to_f + x.to_f
	addi	r29, r29, 6
	lw	r31, -5(r29)

	lwf	f3, -4(r29) # x_float
	fdiv	f2, f2, f3
  owf f2
	fli	f3, 1.5
	fsub	f2, f2, f3
